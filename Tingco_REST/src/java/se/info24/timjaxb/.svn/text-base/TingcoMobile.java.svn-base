...
@XmlRootElement(name = "tingcoMobile")
public class TingcoMobile {
    ...
    @XmlElement(name = "UserMenu", required = true)
    ...
    /**
     * Gets the value of the userMenu property.
     * 
     * @return
     *     possible object is
     *     {@link UserMenu }
    ...
    /**
     * Sets the value of the userMenu property.
     * 
     * @param value
     *     allowed object is
     *     {@link UserMenu }
     *     
     */
    public void setUserMenu(UserMenu value) {
        this.userMenu = value;
    }
