...
/**
 * DeviceHistory generated by hbm2java
 */
public class DeviceHistory  implements java.io.Serializable {
    ...
    public DeviceHistory(String deviceHistoryId, String deviceId, String dataItemId, Date dataItemTime) {
        this.deviceHistoryId = deviceHistoryId;
        this.deviceId = deviceId;
        this.dataItemId = dataItemId;
        this.dataItemTime = dataItemTime;
    }
    public DeviceHistory(String deviceHistoryId, String deviceId, String dataItemId, Date dataItemTime, String groupId, Integer isEnabled, Double posLatitude, Double posLongitude, Double posDepth, Integer posDirection, String coordinateSystemId, String msgId, Date msgTimeStamp, String msgSenderDeviceId, String msgSenderServiceId, Date createdDate, Date updatedDate) {
       this.deviceHistoryId = deviceHistoryId;
       this.deviceId = deviceId;
       this.dataItemId = dataItemId;
       this.dataItemTime = dataItemTime;
    ...
    public void setDeviceHistoryId(String deviceHistoryId) {
        this.deviceHistoryId = deviceHistoryId;
    }
