...
public class UserAliasDetails {
    ...
    protected int isCreditCard;
    @XmlElement(name = "IsServiceKey")
    protected int isServiceKey;
     ...
     * 
     */
    public void setIsCreditCard(int value) {
     ...
     * 
     */
    public void setIsServiceKey(int value) {
