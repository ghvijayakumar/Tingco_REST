 ...
 * &lt;complexType>
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;>ST_ApplicationTypeID">
 *       &lt;attribute name="ApplicationTypeName" use="required">
 *         &lt;simpleType>
...
@XmlRootElement(name = "ApplicationTypeID")
public class ApplicationTypeID {

    @XmlValue
    protected String value;
    @XmlAttribute(name = "ApplicationTypeName", required = true)
