...
/**
 * UserContentCategoriesId generated by hbm2java
 */
public class UserContentCategoriesId  implements java.io.Serializable {


     private String userId;
     private String contentCategoryId;

    public UserContentCategoriesId() {
    }

    public UserContentCategoriesId(String userId, String contentCategoryId) {
       this.userId = userId;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof UserContentCategoriesId) ) return false;
		 UserContentCategoriesId castOther = ( UserContentCategoriesId ) other; 
