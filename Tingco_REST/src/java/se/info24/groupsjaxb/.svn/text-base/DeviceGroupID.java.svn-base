 ...
 * &lt;complexType>
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;>ST_DeviceGroupID">
 *       &lt;attribute name="DeviceGroupName" use="required">
 *         &lt;simpleType>
...
@XmlRootElement(name = "DeviceGroupID")
public class DeviceGroupID {

    @XmlValue
    protected String value;
    @XmlAttribute(name = "DeviceGroupName", required = true)
