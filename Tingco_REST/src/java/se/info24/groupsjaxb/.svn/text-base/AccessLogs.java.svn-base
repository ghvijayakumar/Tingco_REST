 ...
 *       &lt;sequence>
 *         &lt;element ref="{}AccessLog" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AccessLogs {
    ...
    protected List<AccessLog> accessLog;
     ...
     * This is why there is not a <CODE>set</CODE> method for the accessLog property.
     * 
     * <p>
    ...
    public List<AccessLog> getAccessLog() {
        if (accessLog == null) {
            accessLog = new ArrayList<AccessLog>();
        }
