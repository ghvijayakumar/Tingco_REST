 ...
 *         &lt;element name="IsFavorite" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "DeviceDataitemTranslation")
public class DeviceDataitemTranslation {
     ...
     * 
     */
    public void setIsFavorite(int value) {
