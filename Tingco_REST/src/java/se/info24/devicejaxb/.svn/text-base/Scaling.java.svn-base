...
public class Scaling {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "FixedValue", type = JAXBElement.class),
        @XmlElementRef(name = "RawMaxValue", type = JAXBElement.class),
        @XmlElementRef(name = "RawMinValue", type = JAXBElement.class),
        @XmlElementRef(name = "FlagSaveAsFixedValue", type = JAXBElement.class),
        @XmlElementRef(name = "FlagSetValueToMaxIfAboveMax", type = JAXBElement.class),
        @XmlElementRef(name = "FlagSetValueToMinIfBelowMin", type = JAXBElement.class),
        @XmlElementRef(name = "ScaledMaxValue", type = JAXBElement.class),
        @XmlElementRef(name = "FlagScaleValue", type = JAXBElement.class)
    })
    @XmlMixed
